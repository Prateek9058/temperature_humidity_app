...
const CardList = ({ data1, readSDcard, serialData, ReadHistory, ports }) => {
                  ...
                  <Grid container alignItems="center" spacing={2}>
                    <Grid item>
                      {data?.title != "Battery" ? (
                        ...
                        >
                          <Image
                            src={data?.value <= "35 %" ? data?.img : data?.icon}
                            alt={data?.title}
                            height={40}
                            width={40}
                          />
                            ...
                            <Grid>
                              ...
                              {ports.length === 0 && (
                                <Grid container mt={2} gap={2}>
                                  ...
                                  <TbPlugConnected color="red" size={"25px"} />
                                </Grid>
                              )}
                            </Grid>
                          )}
